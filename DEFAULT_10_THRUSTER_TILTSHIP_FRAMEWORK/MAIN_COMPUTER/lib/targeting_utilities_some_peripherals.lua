...
targeting_utilities_some_peripherals = {}

function targeting_utilities_some_peripherals.getTargetAimPos(target_g_pos,target_g_vel,gun_g_pos,gun_g_vel,bullet_vel_sqr)--TargetingUtilities
...
function targeting_utilities_some_peripherals.OnBoardPlayerRadar(
...
function targeting_utilities_some_peripherals.OnBoardShipRadar(ship_radar_component,designated_ship_id,ship_id_whitelist,range)
	return{
...
function targeting_utilities_some_peripherals.RadarSystems(radar_arguments)
	return{
		onboardPlayerRadar = targeting_utilities_some_peripherals.OnBoardPlayerRadar(radar_arguments.ship_reader_component,
		...
		onboardShipRadar = targeting_utilities_some_peripherals.OnBoardShipRadar(radar_arguments.ship_radar_component,
...
function targeting_utilities_some_peripherals.TargetSpatialAttributes()
	return{
...
function targeting_utilities_some_peripherals.TargetingSystem(
	...
	return{
		...
		current_target = targeting_utilities_some_peripherals.TargetSpatialAttributes(),
...
return targeting_utilities_some_peripherals
	...
	local radar_arguments={	ship_radar_component,
							...
							ship_radar_range}
	local radars = targeting_utilities_some_peripherals.RadarSystems(radar_arguments)
	local aimTargeting = targeting_utilities_some_peripherals.TargetingSystem(EXTERNAL_AIM_TARGETING_CHANNEL,aim_targeting_mode,auto_aim,true,false,radars)
	local orbitTargeting = targeting_utilities_some_peripherals.TargetingSystem(EXTERNAL_ORBIT_TARGETING_CHANNEL,orbit_targeting_mode,auto_aim,false,false,radars)
